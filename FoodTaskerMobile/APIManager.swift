...
class APIManager {
    ...
    func login(userType: String, completionHandler: @escaping (NSError?) -> Void) {
        ...
        let params: [String: Any] = [
            ...
            "backend": "facebook",
            "token": "EAAEEZB6IKv5ABABsKYbetQu4ZAZATo8EolzI8UJ4UXeWykUXtdaTZB5ze9aCNQBg0OdLCB6C6ZCIQRD7XZArZATdC5ZB9fxrgkIdsz9GAP3XjATgTPcAi7BkZB4PV8P1qJevZCOcKWUqJnB751hSuQsuWsyY7ZB7l6sP1jbMUZBy37MPOAZDZD",
            "user_type": userType
        ]
