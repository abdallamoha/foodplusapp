...
//  FoodTaskerMobile
//
//  Created by abdalla mohamed on 19/02/2019.
...
//        }
    ...
    func autoZoom() {
        ...
        let insetWidth = -zoomRect.size.width * 0.3
        let insetHeight = -zoomRect.size.height * 0.3
...
extension OrderViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lbSubTotal.text = "UGX\(String(item["sub_total"].float!))"
